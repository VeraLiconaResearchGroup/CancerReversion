...
MBA <- read.table("../SFA_2/attractor_231.txt", row.names = 1) #Raw SFA output
MD231 <- read.table("../SFA_2/231_attractor_discrete", row.names = 1) #Discrete

# Normal attractor (MCF10A)
MCF10A <- read.table("../SFA_2/attractor_10A.txt", row.names = 1) #Raw SFA ouput
MCF <- read.table("../SFA_2/10A_attractor_discrete", row.names = 1) #Discrete

#Simulated attractors
attr <- read.table("../SFA_2/attractor_df.txt", row.names = 1) #Raw
sim <- read.table("../SFA_2/attractor_df_discrete.txt", row.names = 1) #Discrete
...
class <- c("cancerous", "normal", rep("unknown", 100000))
...
plotColoredClusters(hclust, class, c("red", "blue", rep("gray",100000)), cex = 0.8, main = "", line = 0) 
