...
**test_flip** contains the basal states and resultant attractors for the test run with basal expression values for CTNNB1 and GSK3B flipped beteween cancerous and normal initial conditions.
