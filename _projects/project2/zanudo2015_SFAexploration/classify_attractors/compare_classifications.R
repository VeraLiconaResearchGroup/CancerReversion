...
# DACL <- scan('sfa/classify_attractors_newRONs/leukemia_sfaDAC.txt', what = character())
...
# files
sDACL <- 'sfa/classify_attractors_newRONs/leukemia_sfaDAC.txt'
sKSSL <- 'sfa/leukemia_sfa_kmeansSS_10.txt'
sKBL <- 'sfa/leukemia_sfa_kmeansBoth_12.txt'

sDACA <- 'sfa/classify_attractors_newRONs/apoptosis_sfaDAC.txt'
sKSSA <- 'sfa/apoptosis_sfa_kmeansSS_10.txt'
sKBA <- 'sfa/apoptosis_sfa_kmeansBoth_12.txt'

bDACL <- 'boolnet/leukemia_boolnet.txt'
...
bDACA <- 'boolnet/apoptosis_boolnet.txt'
